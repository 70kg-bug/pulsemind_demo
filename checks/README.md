...
`check_service.py` and `floor_margin.py` **re-seed the ward**, which wipes and rebuilds
every collection. That is what they are testing; do not run them against anything you want
to keep.
